...
if("TRUE" STREQUAL "TRUE")
  set(encoder_SOURCE_PREFIX /home/tim/DIGITAL-INPUT-OUTPUT/src/encoder)
  set(encoder_DEVEL_PREFIX /home/tim/DIGITAL-INPUT-OUTPUT/devel)
  set(encoder_INSTALL_PREFIX "")
  set(encoder_PREFIX ${encoder_DEVEL_PREFIX})
else()
  set(encoder_SOURCE_PREFIX "")
  set(encoder_DEVEL_PREFIX "")
  set(encoder_INSTALL_PREFIX /home/tim/DIGITAL-INPUT-OUTPUT/install)
...
if(NOT "/home/tim/DIGITAL-INPUT-OUTPUT/devel/include;/home/tim/DIGITAL-INPUT-OUTPUT/src/encoder/include " STREQUAL " ")
  set(encoder_INCLUDE_DIRS "")
  set(_include_dirs "/home/tim/DIGITAL-INPUT-OUTPUT/devel/include;/home/tim/DIGITAL-INPUT-OUTPUT/src/encoder/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/DIGITAL-INPUT-OUTPUT/src/encoder/${idir}'.  ${_report}")
    endif()
    _list_append_unique(encoder_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "encoder")
