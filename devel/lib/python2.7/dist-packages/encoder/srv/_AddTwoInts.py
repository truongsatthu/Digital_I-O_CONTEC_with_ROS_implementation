...
"""autogenerated by genpy from encoder/AddTwoIntsRequest.msg. Do not edit."""
import sys
...
class AddTwoIntsRequest(genpy.Message):
  ...
  _type = "encoder/AddTwoIntsRequest"
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from encoder/AddTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AddTwoIntsResponse(genpy.Message):
  ...
  _type = "encoder/AddTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
